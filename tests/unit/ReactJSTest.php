...
class ReactJSTest extends \Codeception\Test\Unit {
	...
	public function testCompile() {
		...
		$this . assertEquals("<script>const domContainer = document.querySelector('#root');ReactDOM.render(React.createElement('button',[]), domContainer);</script>", $this->react->compile());
	}
}
